...
# Test vedv::vmobj_entity::get_user_name()

@test 'vedv::vmobj_entity::get_user_name() Should fail If __get_attribute fails' {
  local -r type='invalid'
  local -r vmobj_id='23456'
...
@test 'vedv::vmobj_entity::get_user_name() Should succeed' {
  local -r type='invalid'
  local -r vmobj_id='23456'
