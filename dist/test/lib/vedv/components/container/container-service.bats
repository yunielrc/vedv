...
@test "vedv::container_service::create() Should fail If get_user_name fails" {
  local -r image="image1"
  local -r container_name=''
  ...
  assert_failure
  assert_output "Error getting attribute 'user_name' from the image: 12345"
}

@test "vedv::container_service::create() Should fail If user_name is empty" {
  local -r image="image1"
  local -r container_name=''
  ...
  assert_failure
  assert_output "Attribute 'user_name' is empty for the image '12345'"
}

@test "vedv::container_service::create() Should fail If set_user_name fails" {
  local -r image="image1"
  local -r container_name=''
  ...
  vedv::container_entity::__set_user_name() {
    assert_equal "$*" "12346 vedv"
    return 1
  }
  ...
  assert_failure
  assert_output "Failed to set 'user_name' for container: 12346"
}
# bats test_tags=only
@test "vedv::container_service::create() Should fail If get_workdir fails" {
  local -r image="image1"
  local -r container_name=''
  ...
  assert_failure
  assert_output "Error getting attribute 'workdir' from the image: 12345"
}
# bats test_tags=only
@test "vedv::container_service::create() Should fail If __set_workdir fails" {
  local -r image="image1"
  local -r container_name=''
  ...
  vedv::container_entity::__set_workdir() {
    assert_equal "$*" "12346 workdir"
    return 1
  }
  ...
  assert_failure
  assert_output "Failed to set 'workdir' for container: 12346"
}
